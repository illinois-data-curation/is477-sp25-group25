...
# variables = ["S2301_C01_001E", "S1901_C01_012E","S2701_C01_001E","S1701_C03_001E","DP03_0062E"]  # employment + income
# var_str = ",".join(["NAME"] + variables)
# print(f"Headers for {years}: {variables}")
...
expanded_df.to_csv("data/census_monthly_data.csv", index=False)
